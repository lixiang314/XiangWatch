		...
		<div class="templatemo-content-wrapper">
			<div class="templatemo-content">
				...
				<ul class="nav nav-tabs" role="tablist" id="templatemo-tabs">
					<li class="activecover active"><a href="#all" role="tab" data-toggle="tab">新增人员</a></li>
				...
				<div id="line-hr"></div>
				<div class="new-form">
					<form name="form-people-new" action="action/action-new-people.jsp" method="post">
						<table>
							<tbody>
								<tr>
									<td><label for="name" class="new-form-tips">姓名</label></td>
									<td><input type="text" class="form-control" id="new-name" value="" name="new-name"></td>
								</tr>

								<tr>
									<td><label for="age" class="new-form-tips">年龄</label></td>
									<td><input type="text" class="form-control" id="new-age" value=""  name="new-age"></td>
								</tr>
								...
								<tr>
									...
									<td>
										<span style="margin-right:20px;font-size:15px;">
											<input type="radio" name="new-gender" value="男"> 男 
										</span>
										<span style="margin-right:20px;font-size:15px;">
											<input type="radio" name="new-gender" value="女"> 女 
										</span>
